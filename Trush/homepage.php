...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="https://s2982.pcdn.co/wp-content/uploads/2019/09/books-feature-640x340.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="https://assets.entrepreneur.com/content/3x2/2000/20191219170611-GettyImages-1152794789.jpeg?width=700&amp;crop=2:1" src="https://assets.entrepreneur.com/content/3x2/2000/20191219170611-GettyImages-1152794789.jpeg?width=700&amp;crop=2:1" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="https://image.shutterstock.com/image-photo/close-book-image-heart-shape-600w-1516671212.jpg" class="d-block w-100" alt="...">
    </div>
  </div>
...
<main role="main">
  ...
  <section class="jumbotron text-center">
    <div class="container">
      <h1>Books</h1>
      <p class="lead text-muted">" Lire est une forme de paresse dans la mesure où on laisse le livre penser à la place du lecteur. Le lecteur lit et se figure qu'il pense ; de là ce plaisir qui flatte l'amour-propre d'une illusion délicate. "
       Julien Green</p>
    </div>
  </section> 
  <section>
  <div class="row">
          ...
          <div class="col-lg-4 col-sm-6 mb-4 hover-animate">
            <div class="card shadow border-0 h-100"><a href="cat.php"><img title="" alt="" class="cboxPhoto" src="https://www.insidehighered.com/sites/default/server_files/styles/large/public/media/breaking%20down%20journal.jpg?itok=DSsQPvdE" height="300px" width="400px">
              <div class="card-body"><a href="#" class="text-uppercase text-muted text-sm letter-spacing-2">....</a>
                <h5 class="my-2"><a href="post.html" class="text-dark">Article </a></h5>
          ...
          <!-- blog item-->
          <div class="col-lg-4 col-sm-6 mb-4 hover-animate">
            <div class="card shadow border-0 h-100"><a href="categorie.php"><img width="400" height="300" src="https://www.assessoriarelnutri.com.br/wp-content/uploads/2016/04/Assessoria-relnutri-pasta-de-documentos.jpg" class="attachment-full img-responsive img size-full img-responsive img wp-post-image" alt="Pasta de Documento" title="Pasta de Documento" srcset="https://www.assessoriarelnutri.com.br/wp-content/uploads/2016/04/Assessoria-relnutri-pasta-de-documentos.jpg 500w, https://www.assessoriarelnutri.com.br/wp-content/uploads/2016/04/Assessoria-relnutri-pasta-de-documentos-300x240.jpg 300w" sizes="(max-width: 500px) 100vw, 500px"></a>
              <div class="card-body"><a href="#" class="text-uppercase text-muted text-sm letter-spacing-2">.... </a>
                <h5 class="my-2"><a href="post.html" class="text-dark">Categorie </a></h5>
                <p class="text-gray-500 text-sm my-3"><i class="far fa-clock mr-2"></i>January 16, 2016</p>
          ...
          <!-- blog item-->
          <div class="col-lg-4 col-sm-6 mb-4 hover-animate">
            <div class="card shadow border-0 h-100"><a href="auteuraffichage.php"><img width="350" height="300" src="https://blog.librinova.com/wp-content/uploads/2018/07/Illustration5_V2.jpg" class="img-responsive wp-post-image" alt="">
              <div class="card-body"><a href="#" class="text-uppercase text-muted text-sm letter-spacing-2">... </a>
                <h5 class="my-2"><a href="post.html" class="text-dark">Auteur </a></h5>
                <p class="text-gray-500 text-sm my-3"><i class="far fa-clock mr-2"></i>January 16, 2016</p>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
              ...
              <ul class="list-unstyled">
                <li><a href="compare.html" class="text-muted">Comparison  <span class="badge badge-info-light ml-1">New</span>                                   </a></li>
